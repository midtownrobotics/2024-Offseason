...
//   private LoggedTunableNumber PATHPLANNER_TRANSLATION_P = new
// LoggedTunableNumber("PathPlanner/Translation_P", 2.5);
//   private LoggedTunableNumber PATHPLANNER_TRANSLATION_I = new
// LoggedTunableNumber("PathPlanner/Translation_I", 0);
//   private LoggedTunableNumber PATHPLANNER_TRANSLATION_D = new
// LoggedTunableNumber("PathPlanner/Translation_D", 0);
//   private LoggedTunableNumber PATHPLANNER_ROTATION_P = new
// LoggedTunableNumber("PathPlanner/ROTATION_P", 2);
//   private LoggedTunableNumber PATHPLANNER_ROTATION_I = new
// LoggedTunableNumber("PathPlanner/ROTATION_I", 0);
//   private LoggedTunableNumber PATHPLANNER_ROTATION_D = new
// LoggedTunableNumber("PathPlanner/ROTATION_D", 0);
...
//     PathFollowingController pathFollowerConfig = new PathFollowingController( //
...
//     if (newAutonChoice == null && m_currAutonChoice == null)
//       return;
...
//             }).andThen(
//                 new WaitCommand(0.1).andThen(new InstantCommand(() ->
