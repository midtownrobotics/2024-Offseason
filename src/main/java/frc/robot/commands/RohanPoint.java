...
public class RohanPoint extends Command {
  ...
  private LoggedTunablePIDController m_xController =
      new LoggedTunablePIDController("/RohanPoint/X", 2, 0, 0.15);
  private LoggedTunablePIDController m_yController =
      new LoggedTunablePIDController("/RohanPoint/Y", 2, 0, 0.15);
